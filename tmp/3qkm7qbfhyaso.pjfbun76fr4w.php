      ...
      <div class="container-fluid">
         ...
         <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
               ...
               <li class="navigation" data-page="settings"><a href="index.html">Logout</a></li>
            </ul>
...
{
   var postData = {user: user, pass: pass, license: license, isMobile: isMobile};
...
function checkUpdateTime(token, cg, selectedStore, user, license)
{
   ...
   var user = localStorage.getItem("user");
   var pass = localStorage.getItem("pass");
   var storePost = { token: token, cg: cg, selectedStore: selectedStore, user: user, license: license, pass: pass, isMobile: isMobile };

   $.ajax({
      url: url + 'storeLastUpdate',
      type: "POST",
      dataType: 'json',
      data: storePost,
      crossDomain: true,
...
{
   var postData = {token: token, user: user, pass: pass, license: license, isMobile: isMobile};
